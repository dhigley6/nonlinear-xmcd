...
def make_plot():
    ...
    def plus_minus_plot(high_spec, ax):
        ...
        # Formerly used Pd absorption line:
...
def format_overall_plot(f, axs):
    ...
    axs[1, 0].set_ylabel('Intensity Change (a.u.)')
    ...
    # Formerly used Pd absorption label:
    #axs[0, 0].text(780, 0.36, 'Pd', horizontalalignment='center', transform=axs[0, 0].transData, color='g')
    axs[0, 0].text(777, 1.3, '$\sigma_-$', horizontalalignment='right', transform=axs[0, 0].transData, color='k')
    axs[0, 0].text(779, 0.6, '$\sigma_+$', horizontalalignment='right', transform=axs[0, 0].transData, color='k')
    axs[0, 1].text(775.2, 0.27, 'XAS\n', horizontalalignment='center', transform=axs[0, 1].transData, color='k')
    axs[0, 1].text(775.2, 0.07, '-XMCD', horizontalalignment='center', transform=axs[0, 1].transData, color='k')
    ...
    big_ax.legend(loc='upper center', frameon=True, framealpha=1, borderaxespad=0.3, edgecolor='w', borderpad=0.1)
    big_ax.set_yticks([])
    big_ax.set_xticks([0])
