...
def format_constant_plot(f, axs):
    ...
    axs[0].legend([sync_line, xfel_line], ['ALS', '140 meV\nper atom'], loc='upper right')
    ...
    axs[0].text(777, 0.9, 'XAS', horizontalalignment='right', transform=axs[0].transData, color='k')
    axs[0].text(776.8, 0.1, '-XMCD', horizontalalignment='right', transform=axs[0].transData, color='k')
    axs[1].text(774.6, 0.12, '$2x\Delta$XAS', horizontalalignment='left', transform=axs[1].transData, color='k')
    axs[1].text(774, -0.19, '-$\Delta$XMCD', horizontalalignment='left', transform=axs[1].transData, color='k')
